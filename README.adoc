...
[role="command"]
----
docker run -p 3000:3000 -p 4317:4317 -p 4318:4318 --rm -ti grafana/otel-lgtm:0.9.3
----
...
image::inventory_default_spans_logs.png[`GET /inventory/systems/{hostname}` logs,align="center"]
